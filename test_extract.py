...
# Kaktus 13.09.2026: заголовок и дата без точки, дальше нормальный абзац
# «Иран получил от Китая…». Шов на «от Китая» раньше срезал «Иран получил от»
# — в ленте оставалось «Китая спутниковые снимки…»
_KAKTUS = (
    "WSJ: Китайские спутниковые снимки могли помочь Ирану при ударе по базе США "
    "13 сентября 2026 13:00 Kaktus "
    "Иран получил от Китая спутниковые снимки высокого разрешения до и после "
    "ракетного удара по американской авиабазе Муваффак-Салти в Иордании. "
    "Об этом пишет The Wall Street Journal со ссылкой на американских чиновников. "
    "17 июля Тегеран атаковал авиабазу баллистическими ракетами. Один из ударов "
    "пришелся по зданию, где находились американские военнослужащие. В результате "
    "трое солдат погибли, еще четверо получили ранения. По словам собеседников "
    "издания, администрация президента США Дональда Трампа еще за несколько "
    "месяцев до атаки предупреждала Пекин о том, что китайские компании могут "
    "предоставлять Ирану спутниковые снимки."
)
_k_out = _RL.apply(_KAKTUS)
check("заголовок+дата не режут лид на предлоге",
      _k_out.startswith("Китая спутниковые"), False)
check("лид Kaktus начинается с «Иран получил»",
      "Иран получил от Китая" in _k_out[:80], True)
