...
# ── Часы отключений — не хронометраж плейлиста (Kaktus, 24.09.2026) ──
from extract import VideoPlaylistSanitizer as _VP
_vp = _VP()
_OUTAGE = ("Бишкекское предприятие электрических сетей предупредило об отключении.\n"
           "Восточный РЭС:\n09:30-12:00\n- ул. Ахунбаева, 90\n09:30-18:00\n- ул. Элебаева")
check("часы отключений остаются", "09:30-12:00" in _vp.apply(_OUTAGE), True)
check("диапазон «с 9:00 до 17:00» остаётся",
      _vp.apply("ул. Ахунбаева с 09:00 до 17:00\nул. Элебаева с 10:00 до 16:00\nтекст"),
      "ул. Ахунбаева с 09:00 до 17:00\nул. Элебаева с 10:00 до 16:00\nтекст")
_NBC = ("Trump orders Lake Ontario renamed 'Lake America' 01:25.\n"
        "Americans missing in deadly flood disaster 02:08.\n" + "Real text. " * 30)
check("плейлист NBC по-прежнему снимается", "01:25" in _vp.apply(_NBC), False)
