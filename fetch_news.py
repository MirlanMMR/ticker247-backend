...
3. РЕГИОНАЛЬНЫЙ ПРИОРИТЕТ — аудитория этого пула: {REGIONAL_SPORT_PRIORITY.get(lang, "местного региона")}
   - Победы, медали, финалы, рекорды спортсменов из ЭТОГО региона = priority 2
     Даже выход в четвертьфинал или следующий раунд важен для местной аудитории
     Виды спорта: любые — бокс, борьба, футбол, теннис, MMA, лёгкая атлетика и др.
   - Местные события этого региона (ЧС, отключения, аресты чиновников, ДТП с жертвами) = priority 1-2
     Не фильтруй локальные новости в пользу мировых — для этой аудитории они важнее
   - Победы спортсменов ДРУГИХ регионов для этой аудитории = priority 0-1 (обычные новости)
