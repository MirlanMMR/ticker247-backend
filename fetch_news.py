...
CATEGORY_KEYWORDS = {
    ...
    "KG": ["кыргыз", "бишкек", "ош", "кг ", "кыргызстан",
           "вышел в финал", "вышел в четверть", "победил на", "нокаут", "завоевал медаль",
           "чемпион мира", "чемпион азии", "золото", "серебро", "бронза"],
}
...
3. КЫРГЫЗСТАН И ЦА — особый приоритет:
   - Любой успех спортсмена из КГ/КЗ/УЗ/ЦА = priority 2, даже если это четвертьфинал или выход в следующий раунд
     Примеры: "вышел в финал", "победил", "нокаут", "чемпион", "завоевал медаль", "прошёл в следующий раунд"
     Виды спорта: бокс, борьба, дзюдо, самбо, тяжёлая атлетика, MMA, UFC, футбол, теннис, лёгкая атлетика
   - Внутренние события КГ важны для местной аудитории — не фильтруй их в пользу мировых новостей
