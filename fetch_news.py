...
3. КЫРГЫЗСТАН И ЦА — особый приоритет:
   - Любой результат спортсмена из Кыргызстана, Казахстана, Узбекистана или ЦА = priority 2
     Даже четвертьфинал, выход в следующий раунд, личный рекорд — это важно для аудитории
     Виды спорта: бокс, борьба, дзюдо, самбо, тяжёлая атлетика, MMA, UFC, футбол, теннис, лёгкая атлетика
   - Местные события КГ (коммунальные отключения, ДТП с жертвами, аресты чиновников) = priority 1-2
     Не фильтруй их в пользу мировых новостей — для местной аудитории это важнее
